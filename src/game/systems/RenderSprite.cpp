...
static void offsetRenderPosition(entt::registry &registry, entt::entity entity,
                                 Adagio::Vector2d &position);
static void applyClipping(entt::registry &registry, entt::entity entity,
                          Adagio::SpriteState *spriteState);
static void applyScaling(entt::registry &registry, entt::entity entity,
                         Adagio::SpriteState *spriteState);
static void applyRotation(entt::registry &registry, entt::entity entity,
                          Adagio::SpriteState *spriteState);
static void applyTint(entt::registry &registry, entt::entity entity,
                      Adagio::SpriteState *spriteState);
...
void RenderSprite(entt::registry &registry, Adagio::SpriteBatch &spriteBatch,
  ...
  for (auto [entity, sprite] : view.each()) {
    ...
    auto spriteState = spriteBatch.draw(sprite.texture, position,
                                        static_cast<short>(sprite.zIndex));
