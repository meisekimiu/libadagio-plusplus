...
void EmptyGameState::init() { initCalled = true; }
...
bool EmptyGameState::calledInit() const { return initCalled; }

bool EmptyGameState::calledCleanup() const { return cleanupCalled; }

bool EmptyGameState::calledLoadContent() const { return loadContentCalled; }

bool EmptyGameState::calledUnloadContent() const { return unloadContentCalled; }

bool EmptyGameState::calledUpdate() const { return updateCalled; }

bool EmptyGameState::calledDraw() const { return drawCalled; }

bool EmptyGameState::calledPause() const { return pauseCalled; }

bool EmptyGameState::calledResume() const { return resumeCalled; }

float EmptyGameState::lastFrameTime() const { return frameDelta; }
...
void EmptyGameState::resume(Adagio::RenderingServices &services) {
  resumeCalled = true;
}
