...
struct TestingTextureLoader : public Adagio::TextureLoader<TestingTexture> {
    std::pair<TestingTexture, Adagio::TextureDimensions>
...
TEST_CASE("TextureManager loads different handles for textures",
          "[TextureManager]") {
    TestingTextureLoader loader;
    Adagio::TextureManager<TestingTexture> texman(&loader);
...
TEST_CASE("TextureManager will reuse handles when a texture is unloaded",
          "[TextureManager]") {
    TestingTextureLoader loader;
    Adagio::TextureManager<TestingTexture> texman(&loader);
...
TEST_CASE(
        "TextureManager will keep higher handles intact when a texture is unloaded",
        "[TextureManager]") {
    TestingTextureLoader loader;
    Adagio::TextureManager<TestingTexture> texman(&loader);
...
TEST_CASE("TextureManager can fetch internal data from the texture library",
          "[TextureManager]") {
    TestingTextureLoader loader;
    Adagio::TextureManager<TestingTexture> texman(&loader);
...
TEST_CASE(
        "TextureManager will detect if the user is fetching an invalid texture",
        "[TextureManager]") {
    TestingTextureLoader loader;
    Adagio::TextureManager<TestingTexture> texman(&loader);
...
TEST_CASE("TextureManager can detect if same texture is loaded twice and reuse "
          "the same resource",
          "[TextureManager]") {
    TestingTextureLoader loader;
    Adagio::TextureManager<TestingTexture> texman(&loader);
...
TEST_CASE("TextureManager will free up resource names when unloading textures",
          "[TextureManager]") {
    TestingTextureLoader loader;
    Adagio::TextureManager<TestingTexture> texman(&loader);
...
TEST_CASE("TextureManager can use a hash to grab a loaded texture", "[TextureManager]") {
    TestingTextureLoader loader;
    Adagio::TextureManager<TestingTexture> texman(&loader);

    auto tex = texman.load("potato.jpg");
    auto tex2 = texman.getTexture("potato.jpg"_hs);
    REQUIRE(tex.handle == tex2.handle);
    REQUIRE(tex.getSecretId() == tex2.getSecretId());
}
