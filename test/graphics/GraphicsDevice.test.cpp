...
TEST_CASE("MockGraphicsDevice registers renders in call order",
          "[GraphicsDevice]") {
  MockGraphicsDevice mockGraphicsDevice;
  Adagio::GraphicsDevice *gd = &mockGraphicsDevice;
  ...
  std::vector<Adagio::RenderState *> renders =
      *mockGraphicsDevice.getDrawnObjects();
...
TEST_CASE("MockGraphicsDevice clears the drawnObjects list after begin()",
          "[GraphicsDevice]") {
  MockGraphicsDevice mockGraphicsDevice;
  Adagio::GraphicsDevice *gd = &mockGraphicsDevice;
