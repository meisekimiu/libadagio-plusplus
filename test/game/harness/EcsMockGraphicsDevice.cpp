...
void EcsMockGraphicsDevice::begin() { spritesRenderedOnFrame.clear(); }
...
void EcsMockGraphicsDevice::drawTexture(Adagio::Texture2D &texture,
...
const std::vector<Adagio::SpriteState> *
EcsMockGraphicsDevice::getSprites() const {
    return &spritesRenderedOnFrame;
}

void EcsMockGraphicsDevice::drawText(const Adagio::Font &font, const char *text,
...
Adagio::AbstractFontManager *EcsMockGraphicsDevice::getFontManager() {
    return &fontLibrary;
}
